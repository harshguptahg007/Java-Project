...
public class HUD
{
	...
	public void draw(Graphics2D g)//to draw health,chance,level and fire remaining
	{
		...
		g.drawString(player.getLives() + "/" + player.getMaxLives(),53,	25);
		g.setFont(font);
		g.drawString(player.getFire() / 100 + "/" + player.getMaxFire() / 100,30,45);
		g.setColor(Color.BLACK);
		g.setFont(font2);
		g.drawString("Level " +   player.getLevel(),15,	65);
