...
public class Boss1 extends Enemy
{
	...
	public Boss1(TileMap tm) {
		...
		try
		{
			...
			for(int i = 0; i < sprites.length; i++) {
				sprites[i] = spritesheet.getSubimage(i * width,height,width,height);//(x,y,width,height)
				//boss1 is the red wala snail
			}
		}
		catch(Exception e) {
			e.printStackTrace();
	...
	private void getNextPosition()//to get next position
	{
		if(health >=1)
