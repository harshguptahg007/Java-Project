...
public class Level2State extends GameState
{
	...
	private AudioPlayer bgMusic;//for background music
	private AudioPlayer item;//for sound effects
	private TileMap tileMap;
	private Background bg;
	Random rand = new Random();//random function generator to generate random values
	...
	private ArrayList<Explosion> explosions;//list of explosion sounds
	private ArrayList<Object> objects;//lists of hearts that will occur
	...
	public void draw(Graphics2D g)
	{
		...
		String s = "Level 3: Grass Pillars";
